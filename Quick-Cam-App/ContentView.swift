            ...
            ZStack {
                ...
                if let selectedVideo = selectedPreviousVideo {
                    ...
                    PreviewView(
                        ...
                        onSave: { title, enableCaptions, enhanceAudio, captionStyle, language, preTranscribedCaptions in
                            cameraViewModel.exportToDownloads(title: title, enableCaptions: enableCaptions, enhanceAudio: enhanceAudio, aspectRatio: cameraViewModel.selectedAspectRatio, captionStyle: captionStyle, language: language, preTranscribedCaptions: preTranscribedCaptions) { success, path in
