            ...
            ZStack {
                ...
                if let selectedVideo = selectedPreviousVideo {
                    ...
                    PreviewView(
                        ...
                        onSave: { title, enableCaptions, enhanceAudio, captionStyle, language in
                            cameraViewModel.exportToDownloads(title: title, enableCaptions: enableCaptions, enhanceAudio: enhanceAudio, aspectRatio: cameraViewModel.selectedAspectRatio, captionStyle: captionStyle, language: language) { success, path in
